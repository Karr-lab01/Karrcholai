...
const Services = () => {
 ...
 <div className="text-6xl md:text-9xl text-primary/5 mb-[-30px] md:mb-[-60px] font-black select-none">0{idx + 1}</div>
 ...
 Why Choose <br /> <span className="text-primary">Karrcholai.</span>
 </h3>
 ...
 <p className="text-dark/40 text-base md:text-xl font-light mb-10 md:mb-12 leading-relaxed">
