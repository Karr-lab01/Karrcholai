...
const PROJECTS_DATA = [
 ...
 { label: 'Concrete Used', value: '850 mÂ³' },
...
const ProjectDetail = () => {
 ...
 <p className="text-sm md:text-base font-light text-white/70 drop-shadow-sm">
 {project.subtitle}
 </p>
 </motion.div>
 </div>
 ...
 Engineering <span className="text-dark/20">meets</span> architectural <span className="text-[#C9754A]">poetry.</span>
 </h2>
 ...
 Inspired by this <br />
 <span className="text-[#C9754A]">Structure?</span>
 </h2>
